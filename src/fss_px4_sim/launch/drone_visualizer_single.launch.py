    ...
    return LaunchDescription([
        GroupAction(
            ...
            DeclareLaunchArgument(
                ...
                ]), # use LaunchConfiguration for default value is dangerous, since it may not exactly use the LaunchArgument declared in this file, but use the LaunchArgument from the parent launch file, which may have a different default value. So we use GroupAction(scoped=True) at the beginning to force the LaunchConfiguration to use the LaunchArgument declared in this file scope.
            ),
            DeclareLaunchArgument("base_link_name", default_value="base_link"),
            DeclareLaunchArgument("base_link_tf_prefix", default_value=LaunchConfiguration("namespace")),  # use LaunchConfiguration for default value is dangerous, since it may not exactly use the LaunchArgument declared in this file, but use the LaunchArgument from the parent launch file, which may have a different default value. So we use GroupAction(scoped=True) at the beginning to force the LaunchConfiguration to use the LaunchArgument declared in this file scope.
