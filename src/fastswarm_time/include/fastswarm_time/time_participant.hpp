...
private:
  ...
  void tick();
  void on_intent(const fastswarm_time_interfaces::msg::TimeIntent::SharedPtr msg);
  void on_control(const fastswarm_time_interfaces::msg::TimeControl::SharedPtr msg);

  rclcpp::Node & node_;
  std::string participant_id_;
  uint64_t epoch_{0};
  int64_t next_safe_time_ns_{0};
  uint8_t intent_state_{fastswarm_time_interfaces::msg::TimeIntent::STATE_IDLE};
  ...
  rclcpp::Publisher<fastswarm_time_interfaces::msg::TimeIntent>::SharedPtr intent_pub_;
  rclcpp::Publisher<rosgraph_msgs::msg::Clock>::SharedPtr clock_pub_;
  rclcpp::Subscription<fastswarm_time_interfaces::msg::TimeIntent>::SharedPtr intent_sub_;
  rclcpp::Subscription<fastswarm_time_interfaces::msg::TimeControl>::SharedPtr control_sub_;
