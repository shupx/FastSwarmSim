...
`fastswarm_px4_sim` currently provides a ROS 2 port of the original perfect MAVROS drone.
...
4. Use `fastswarm_time::TimeParticipant` in the 100 Hz agent loop to announce each agent's next safe integration time.
