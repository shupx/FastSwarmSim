...
public:
  ...
  : Node("perfect_mavros_quadrotor_sim")
  {
    ...
    const auto enable_fastswarm_time = declare_parameter<bool>("enable_fastswarm_time", true);
...
private:
  ...
  std::unique_ptr<fastswarm_time::TimeParticipant> time_participant_;
